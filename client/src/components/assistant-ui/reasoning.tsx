...
function ReasoningTrigger({
  ...
  return (
    ...
    >
      ...
      />
      <span
        className="aui-reasoning-trigger-label-wrapper relative inline-block tabular-nums leading-none"
...
function ReasoningText({
  ...
  return (
    <div
      className={cn(
        "aui-reasoning-text relative z-0 max-h-64 overflow-y-auto text-pretty ps-6 pt-2 pb-2 leading-relaxed",
      ...
      {...props}
    >
      <div className="aui-reasoning-text-content space-y-4" ref={contentRef}>
        {children}
      </div>
    </div>
  );
