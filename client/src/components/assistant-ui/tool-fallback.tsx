...
function ToolFallbackArgs({
  ...
  return (
    <div
      ...
      {...props}
    >
      <pre className="aui-tool-fallback-args-value whitespace-pre-wrap rounded-md bg-muted/50 p-2.5 text-foreground/90 text-xs">
        {argsText}
      </pre>
    </div>
  );
...
function ToolFallbackResult({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-result-header font-medium text-muted-foreground text-xs">
        Result:
      </p>
      <pre className="aui-tool-fallback-result-content mt-1 whitespace-pre-wrap rounded-md bg-muted/50 p-2.5 text-foreground/90 text-xs">
...
const ToolFallbackImpl: ToolCallMessagePartComponent = ({
  ...
  return (
    <ToolFallbackRoot onOpenChange={setOpen} open={open}>
