...
function NumberRollDigit({ digit, dir }: { digit: number; dir: number }) {
  ...
  return (
    <span
      className="relative inline-block overflow-clip duration-(--aui-number-roll-duration) ease-(--aui-number-roll-ease) [transition-property:--aui-number-roll-pos] motion-reduce:transition-none"
